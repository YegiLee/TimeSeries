...
class COCODataset(GeneralizedDataset):
    def __init__(self, file_root, ann_file, train=False, transforms=None):
        print("========coco_dataset.py COCODataset __init__()========")
        super().__init__()
    ...
    def get_image(self, img_id):
        print("========coco_dataset.py COCODataset get_image()========")
    ...
    def convert_to_xyxy(box): # box format: (xmin, ymin, w, h)
        print("========coco_dataset.py COCODataset convert_to_xyxy()========")
    ...
    def get_target(self, img_id):
        print("========coco_dataset.py COCODataset get_target()========")
